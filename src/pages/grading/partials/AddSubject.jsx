...
export default function AddSubject(){
    ...
    return(
        ...
        <Dialog open={open} maxWidth="sm" fullWidth onClose={() => setOpen(false)}>
            <DialogTitle className='fw-bolder'>Add New Subject for SECTION</DialogTitle>
            <Divider />
            <DialogContent>
                <form>
                    <div className="d-flex flex-column gap-3">
                        <TextField label="Subject Title" variant="outlined" />
                        <Autocomplete
                            id="combo-box-demo"
                            options={top100Films}
                            fullWidth
                        ...
                        />
                        <TextField type="time" label="Start Time" variant="outlined" value={"07:30"}/>
                        <TextField type="time" label="End Time" variant="outlined" value={"07:30"}/>
                        <FormControl>
                            <InputLabel id="grade_level_label">Schedule</InputLabel>
                            <Select labelId="grade_level_label" label="Schedule" fullWidth>

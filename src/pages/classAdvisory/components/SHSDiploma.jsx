...
export default function SHSDiploma({advisory, student}){
            ...
            <DialogContent className="d-flex flex-row">
                <div className="col-4 d-flex flex-column p-2">
                    <div className="d-flex flex-row align-items-center">
                        <h2 className="m-0 fw-bolder text-dark">Diploma Settings</h2>
                    ...
                    <div className="mt-2 d-flex flex-row gap-2 w-100">
                        <div className="d-flex flex-column col-6">
                            <label>Track</label>
                            <input type="text" className="form-control" value={state.track} onChange={(e) => handleInputChange(e.target.value, "set_track")} />
                        </div>
                        <div className="d-flex flex-column col-6">
                            <label>Strand</label>
                ...
                <div className="col-8 d-flex flex-column p-2">
                    {open && (
                        <SHSDiplomaPrintable advisory={advisory} student={student} overrides={overrides}/>
                    )}
                </div>
            </DialogContent>
            <DialogActions>

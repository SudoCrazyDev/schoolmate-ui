...
export default function NewSection(){
    ...
    return(
        <>
        <Button variant="contained" className='fw-bolder' onClick={() => setOpen(true)}>New Section</Button>
                    ...
                    <div className="d-flex flex-column gap-3">
                        ...
                        <FormControl>
                            ...
                            <Select labelId="grade_level_label" label="Grade Level" fullWidth>
                                <MenuItem value={10}>Grade 7</MenuItem>
                                <MenuItem value={20}>Grade 8</MenuItem>
                                <MenuItem value={30}>Grade 9</MenuItem>
                                <MenuItem value={31}>Grade 10</MenuItem>
                                <MenuItem value={32}>Grade 11</MenuItem>
                                <MenuItem value={33}>Grade 12</MenuItem>
                            </Select>
                        </FormControl>
                        <Autocomplete
                            id="combo-box-demo"

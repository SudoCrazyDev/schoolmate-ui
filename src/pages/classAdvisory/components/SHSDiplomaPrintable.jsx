                    ...
                    <View style={{display: "flex", flexDirection: "column", height: "100%"}}>
                        ...
                        <View style={{paddingTop:"20px", display: "flex", flexDirection: "row", justifyContent: "center"}}>
                            <View style={{flexGrow:"1",display: "flex", flexDirection:"column", alignItems: "center", gap: "3px"}}>
                                ...
                                <Text style={styles.strandTitle}>{overrides?.strand}</Text>
                                <Text style={{marginTop: "10px"}}>na itinakda para sa Mataas na Paaralan ng Kagawaran ng Edukasyon, kaya pinagkalooban siya nitong</Text>
                                <Text style={styles.smallFont2}>prescribed for Secondary Schools of the Department of Education and is therefore awarded this</Text>
                                <Text style={styles.katunayan}>KATIBAYAN</Text>
                                <Text style={styles.certificate}>DIPLOMA</Text>
